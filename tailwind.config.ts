  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        feature: {
          card: "hsl(var(--feature-card))",
          "card-dark": "hsl(var(--feature-card-dark))",
          accent: "hsl(var(--feature-accent))",
        },
        cta: {
          "gradient-from": "hsl(var(--cta-gradient-from))",
          "gradient-to": "hsl(var(--cta-gradient-to))",
          "gradient-from-hover": "hsl(var(--cta-gradient-from-hover))",
          "gradient-to-hover": "hsl(var(--cta-gradient-to-hover))",
        },
        code: {
          bg: "hsl(var(--code-bg))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px rgba(40, 122, 120, 0.3)" },
          "50%": { boxShadow: "0 0 40px rgba(40, 122, 120, 0.5)" },
        },
        "gradient-shift": {
